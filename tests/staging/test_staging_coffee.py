"""
An example of staging test from course
Best practice as said would be to use the staging fixture
in another file inside staging folder.

@dev learning purposes
"""
